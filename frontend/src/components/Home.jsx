...
const Home = () => {
  ...
  return (
    <div className="bg-mainGreen font-montserrat pt-32 pb-20">
      <div className="text-center text-mainWhite">
        <img className="mx-auto" src={logo} alt="Serenade Logo"></img>
        <h2 className="font-extra-bold text-lg my-14 w-1/3 mx-auto">
          Sing along with friends from the comfort of your own home on this
          virtual karaoke platform!
        </h2>
      </div>
