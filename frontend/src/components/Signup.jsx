...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        `https://karaoke-backend-exp-production.up.railway.app/auth/signup`,
        {
          email: email,
          password: password,
          firstName: firstname,
  ...
  const handleUpload = (e) => {
    ...
    reader.onloadend = () => {
      ...
      img.onload = () => {
        //when the image is loaded, we can resize it
        let width = img.width;
  ...
  return (
    <div className="bg-lightGreen font-montserrat pt-32 pb-20 flex flex-col items-center justify-center">
          ...
          <div className="flex items-center justify-center mb-4">
            <div className="flex flex-col">
              <input
                ...
                name="firstname"
                className="rounded p-2 mt-4 w-64"
              ></input>
              <input
                type="text"
                onChange={(e) => {
            ...
            <div className="flex flex-col items-center justify-center ml-8">
              <div className="bg-bgGreen rounded p-2 mb-2 w-64 flex flex-col items-center justify-center mt-4">
                ...
                <input
                  ...
                  name="image"
                  className="w-64 flex text-center p-2"
                ></input>
                <button
                  type="button"
